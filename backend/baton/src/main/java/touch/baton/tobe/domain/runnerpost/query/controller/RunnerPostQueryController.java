package touch.baton.tobe.domain.runnerpost.query.controller;
...
import touch.baton.tobe.domain.runnerpost.command.controller.response.SupporterRunnerPostResponses;
