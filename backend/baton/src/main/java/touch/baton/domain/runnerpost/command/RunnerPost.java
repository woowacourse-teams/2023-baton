package touch.baton.domain.runnerpost.command;
...
public class RunnerPost extends BaseEntity {
    ...
    public void assignSupporter(final Supporter supporter) {
        ...
        if (reviewStatus.isSame(ReviewStatus.OVERDUE)) {
