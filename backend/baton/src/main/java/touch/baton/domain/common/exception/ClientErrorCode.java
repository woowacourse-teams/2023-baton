...
public enum ClientErrorCode {
    ...
    RUNNER_PROFILE_NAME_IS_NULL(HttpStatus.BAD_REQUEST, "RNP001", "러너의 이름을 입력해주세요."),
    RUNNER_PROFILE_INTRODUCTION_IS_NULL(HttpStatus.BAD_REQUEST, "RNP002", "러너의 자기소개를 입력해주세요.");
