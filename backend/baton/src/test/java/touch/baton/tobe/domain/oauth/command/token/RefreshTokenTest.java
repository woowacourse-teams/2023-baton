...
import touch.baton.tobe.domain.oauth.command.token.exception.RefreshTokenDomainException;
...
import static touch.baton.tobe.domain.oauth.command.token.RefreshToken.builder;
