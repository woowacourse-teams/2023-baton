...
class RunnerPostReadWithLoginedSupporterAssuredTest extends AssuredTestConfig {
    ...
    void 로그인된_서포터의_진행중인_러너_게시글_목록_조회에_성공한다() {
        ...
        final RunnerPostResponse.ReferencedBySupporter 서포터가_리뷰를_진행중인_러너_게시글_응답 = 서포터와_연관된_러너_게시글_응답(
                리뷰_진행중인_디투_러너_게시글,
                List.of("자바", "스프링"),
                0,
                디투_러너_게시글에_지원한_서포터_수,
        ...
        RunnerPostAssuredSupport
                ...
                .서버_응답()
                .서포터와_연관된_러너_게시글_페이징_조회_성공을_검증한다(
                        서포터와_연관된_러너_게시글_페이징_응답(페이징_정보, List.of(서포터가_리뷰를_진행중인_러너_게시글_응답))
                );
    }
    ...
    void 로그인된_서포터의_완료된_러너_게시글_목록_조회에_성공한다() {
        ...
        final RunnerPostResponse.ReferencedBySupporter 서포터가_리뷰를_완료한_러너_게시글_응답 = 서포터와_연관된_러너_게시글_응답(
                리뷰가_완료된_디투_러너_게시글,
                List.of("자바", "스프링"),
                0,
                디투_러너_게시글에_지원한_서포터_수,
