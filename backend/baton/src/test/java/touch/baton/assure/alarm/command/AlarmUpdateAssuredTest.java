...
import touch.baton.assure.alarm.support.command.AlarmUpdateSupport;
...
class AlarmUpdateAssuredTest extends AssuredTestConfig {

    @Test
    void 로그인한_사용자의_알람_읽기_여부_기록을_업데이트한다() {
        // given
        ...
        AlarmUpdateSupport
                .클라이언트_요청()
                .액세스_토큰으로_로그인한다(헤나_액세스_토큰)
                .알람_읽음_여부_기록_업데이트를_요청한다(저장된_알람.getId())

                .서버_응답()
                .알람_읽음_여부_기록_업데이트_성공을_검증한다();
    }
