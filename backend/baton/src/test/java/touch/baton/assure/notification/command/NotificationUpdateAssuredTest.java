...
import touch.baton.assure.notification.support.command.NotificationUpdateSupport;
...
class NotificationUpdateAssuredTest extends AssuredTestConfig {

    @Test
    void 로그인한_사용자의_알림_읽기_여부_기록을_업데이트한다() {
        // given
        ...
        NotificationUpdateSupport
                .클라이언트_요청()
                .액세스_토큰으로_로그인한다(헤나_액세스_토큰)
                .알림_읽음_여부_기록_업데이트를_요청한다(저장된_알림.getId())

                .서버_응답()
                .알림_읽음_여부_기록_업데이트_성공을_검증한다();
    }
