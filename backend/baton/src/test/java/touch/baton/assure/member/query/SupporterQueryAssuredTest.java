...
import touch.baton.assure.member.support.query.SupporterQueryAssuredSupport;
...
import static touch.baton.assure.member.support.query.SupporterQueryAssuredSupport.서포터_MyProfile_응답;
import static touch.baton.assure.member.support.query.SupporterQueryAssuredSupport.서포터_Profile_응답;

@SuppressWarnings("NonAsciiCharacters")
class SupporterQueryAssuredTest extends AssuredTestConfig {
