package touch.baton.document.alarm.delete;
...
class AlarmDeleteApiTest extends RestdocsConfig {
    ...
    @DisplayName("알람 삭제 API")
    @Test
    void deleteAlarmByAlarmId() throws Exception {
        // given
