...
public class RankReadApiTest extends RestdocsConfig {
    ...
    void readMostReviewSupporter() throws Exception {
        ...
        final List<RankResponses.SupporterResponse> response = List.of(
                new RankResponses.SupporterResponse(1, "ethan", 1L, 10, "imageUrl", "githubUrl", List.of("java", "spring")),
                new RankResponses.SupporterResponse(2, "hyena", 2L, 9, "imageUrl", "githubUrl", List.of("java", "spring")),
                new RankResponses.SupporterResponse(3, "ditoo", 3L, 8, "imageUrl", "githubUrl", List.of("java", "spring")),
                new RankResponses.SupporterResponse(4, "aiden", 4L, 7, "imageUrl", "githubUrl", List.of("javascript", "react")),
                new RankResponses.SupporterResponse(5, "ditoo", 5L, 6, "imageUrl", "githubUrl", List.of("javascript", "react"))
        );
